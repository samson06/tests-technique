...
/**
 * Integration tests for {@link EventRepository}
 * 
...
public class EventRepositoryTest
{
    //
    //
    private static final String TITLE = "Les Vieilles Charrues";
    private static final String NAME = "AC/DC";
    private static final String MEMBER_NAME = "Queen Kimberly Jacobs";
    ...
    {
        assertThat(this.eventRepository.findAllBy().size()).isEqualTo(5);
    }
    ...
    public void testSave()
    {
        ...
        assertThat(this.eventRepository.findAllBy().size()).isEqualTo(6);
    }
    ...
    public void testFindOneWithBandsById()
    {
        ...
        assertThat(bands.get(0).getName()).isEqualTo(NAME); // 1006
        ...
        assertThat(members.get(0).getName()).isEqualTo(MEMBER_NAME); // 1021
    }
